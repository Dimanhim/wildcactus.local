...
$arrPostcalcConfig=array(
    ...
    // === НАСТРОЙКИ ЗАПРОСА ===
    'st' => 'wildcactus.local',        // Название сайта, без http: и слэшей
    'ml' => 'dimanhim@list.ru',     // Контактный email. Самый принципиальный параметр
    ...
    // === НАСТРОЙКИ ВЕБ-ФОРМЫ ===
    'default_from' => '355040',   // Отделение отправителя по умолчанию. 101000 - Московский главпочтамт.
